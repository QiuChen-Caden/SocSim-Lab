  ...
  return (
    <div className="split">
      <section className="world">
        <div className="panel world__canvas">
          <div className="panel__hd">
            <div className="panel__title">World View 世界视图</div>
        ...
        {graphOpen && (
          <div className="panel">
            <div className="panel__hd">
              <div className="panel__title">Agent Graph 图谱（demo）</div>
        ...
        <div className="panel">
          <div className="panel__hd">
            <div className="panel__title">Timeline 时间轴</div>
            <div className="row">
              ...
              <button
                className="btn"
                onClick={() =>
                  sim.actions.pushEvent({ tick: sim.state.tick, type: 'bookmark', title: `Bookmark @tick ${sim.state.tick}` })
                }
              >
                Bookmark 书签
              </button>
      ...
      <aside className="panel">
        <div className="panel__hd">
          ...
          <div className="row">
            {alerts.length > 0 && <span className="pill pill--danger">alerts 警告: {alerts.length}</span>}
            {selected != null && <span className="pill">agent 智能体_{selected}</span>}
        ...
        <div className="panel__bd">
          <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
            <div className="panel__hd">
              <div className="panel__title">World Controls</div>
              <span className="pill">把控件挪到右侧</span>
            </div>
            <div className="panel__bd">
              <div className="row">
                <div style={{ width: 210 }}>
                ...
                <div style={{ flex: 1, minWidth: 220 }}>
                  <div className="row" style={{ justifyContent: 'space-between' }}>
                    ...
                    <span className="pill">x{zoomLevel.toFixed(2)}</span>
                  </div>
                  <input
                    className="input"
                    type="range"
          ...
          {selected == null || !agent ? (
            <div className="muted">点击世界中的实体，或在下方输入 agentId 进行选择。Click an entity in the world or enter agentId below to select.</div>
          ) : (
            <>
              <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
                <div className="panel__hd">
                  <div className="panel__title">Agent Profile 智能体画像</div>
                  <div className="row">
              ...
              <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
                <div className="panel__hd">
                  <div className="panel__title">Psychometrics 心理测量</div>
                </div>
                <div className="panel__bd">
                  ...
                  {(
                    ...
                    <div key={k} style={{ display: 'grid', gridTemplateColumns: '180px 1fr 38px', gap: 8, alignItems: 'center', marginBottom: 6 }}>
                  ...
                  {(
                    ...
                    <div key={k} style={{ display: 'grid', gridTemplateColumns: '140px 1fr 38px', gap: 8, alignItems: 'center', marginBottom: 6 }}>
                      <div className="muted" style={{ fontSize: 12 }}>
                        {k}
                      </div>
                      <div className="bar">
              ...
              <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
                <div className="panel__hd">
                  <div className="panel__title">Cognitive State 认知状态</div>
                  <span className="pill pill--warn">{agent.profile.cognitive_state.core_affect.sentiment}</span>
                </div>
                <div className="panel__bd">
              ...
              <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
                <div className="panel__hd">
                  <div className="panel__title">Behavior Profile 行为画像</div>
                </div>
                <div className="panel__bd">
                  <div className="kv" style={{ gridTemplateColumns: '140px 1fr', marginBottom: 10 }}>
              ...
              {groupProfile && (
                <div className="panel panel--nested" style={{ marginBottom: 'var(--space-md)' }}>
                  <div className="panel__hd">
                    <div className="panel__title">Group Profile 群体画像</div>
                    <span className="pill">{groupProfile.label}</span>
                  </div>
                  <div className="panel__bd">
